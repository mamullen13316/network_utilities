...
and collect the output of a specified command or list of commands.  The output will be printed to stdout and also saved
...
if __name__ == '__main__':
    ...
    parser.add_argument('-command-list',help='A command or list of commands separated by a semi-colon ;',required=False)
    ...
    if args.command_list:
        ...
        command_list = raw_input("Enter command(s) to run separated by ; ")  
    ...
    command_list = [element.strip(' ') for element in command_list.split(';')]
    ...
    for host in devicelist:
        ...
        for command in command_list:
            output_list.append('-'*25 + command + '-'*25)
    ...
    if connect_success:
        ...
        outputdir = 'getoutput-{}{}{}{}{}{}'.format(mo,dy,yr,hr,mn,sc)
        os.mkdir(outputdir)
